    ...
    return (
        <div className="fqa">
            ...
            <div className="questions pb-[5.625rem]">
                <ul>
                    <li className="flex justify-between items-start py-4 px-8 pb-8 border-t-[1px] border-black">
                    ...
                    <li className="flex justify-between items-start py-4 px-8 pb-8 border-t-[1px] border-b-[1px] border-black">
                        <div className="question">
